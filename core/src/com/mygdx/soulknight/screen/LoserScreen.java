...
public class LoserScreen implements Screen {
    ...
    public LoserScreen(final SoulKnightGame game){
        this.game = game;
    ...
    public void show() {
        ...
        stage.clear();
        MediaLose.backgroundMusic.setLooping(true);
        MediaLose.backgroundMusic.play();
        initButtons();
    }
    @Override
    public void render(float delta) {
        ...
        stage.getBatch().draw(MediaLose.LoserPicture, 0,0);
        stage.getBatch().end();
        stage.draw();
