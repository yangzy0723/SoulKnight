...
public class NetKnight extends NetPlayer implements Json.Serializable{
    public NetKnight(){};
    public NetKnight(float startX, float startY, int id) {
        this.x = startX;
        this.y = startY;
        this.width = Variable.KNIGHT_WIDTH;
        this.height = Variable.KNIGHT_HEIGHT;

        this.image = MediaGamePlaying.knightLeft;

        this.health = Variable.KNIGHT_HEALTH;
        this.defense = Variable.KNIGHT_DEFENSE;
        this.attack = Variable.KNIGHT_ATTACK;
        this.speed = Variable.KNIGHT_SPEED;

        this.id = id;
        this.typeNetPlayer = TypeNetPlayer.Knight;
